...
namespace spades {
	namespace draw {
		...
		GLMapRenderer::GLMapRenderer(client::GameMap *m, GLRenderer &r)
			...
			mapBlockImage = renderer.RegisterImage("Textures/MapBlock.png").Cast<GLImage>();
			multiMapBlockImage = renderer.RegisterImage("Textures/MultiMapBlock.png").Cast<GLImage>();
		...
		void GLMapRenderer::RenderSunlightPass() {
			...
			glowBlocks.SetValue(renderer.GetSceneDef().allowGlowBlocks);
